...
Tags: Allopass, Hipay, Hipay mobile, Mobiyo, Sale, Product, Post, Page, Subscription, Membership, Earn money, Monetize, Paypal, SMS, Shortcode, Buddypress, Ajax
Requires at least: 2.6
Tested up to: 5.3
Stable tag: 5.3

The Wp Easy Allopass Plugin (WEA) is a plugin that allows you to integrate allopass (HiPay Mobile - Mobiyo) payment solution on your wordpress site.
== Description ==

The Wp Easy Allopass Plugin (WEA) is a plugin that allows you to integrate **allopass payment solution** (HiPay Mobile - Mobiyo) on your wordpress site. With WEA plugin, you can easily sell unlimited products in your posts and pages. It allows your visitor to buy directly digital contents from your site. See live demo [here](http://www.gasy.prod.bz/wea-wordpress-easy-allopass-plugin-demo/ "here").
...
1. Create your *FREE* [Hipay Merchant Account](http://en.allopass.com/advert?from=sponsorship&target=6413634 "Hipay Merchant Account"): (Already have an account? skip this step)
2. Once logged in your [Hipay Merchant Account](http://en.allopass.com/advert?from=sponsorship&target=6413634 "Hipay Merchant Account"), add your own site in your hipay "[sites list](https://merchant.hipaymobile.com/merchant/product/site "sites list")". Click the "**Add a new site**" button.
3. Add the product you want to sell with your site. In the section [My products](https://merchant.hipaymobile.com/merchant/product/site "My products"), Click the "**Add a new product**" button and enter informations about your product.
4. When you have finished to add product in your allopass account. You can get the "**Site Id**" and the "**Product Id**" in your hipay mobile dashboard.

**WARNING**: When you add new product on your hipay account, always set as **return URL: "http://www.Your_Site.com"**. After purchase, the WEA plugin will automatically redirect user to the page that he was visiting before.
...
3. Enter the "**Site Id**" and "**Product Id**" created in step 4 above.
...
Once logged in your [Hipay Merchant Account](http://en.allopass.com/advert?from=sponsorship&target=6413634 "Allopass Merchant Account"), enter in the section [My products](https://merchant.hipaymobile.com/merchant/product/site "My products"). Select one of your site. If you have already added a product for this site, you will see "**site Id**" and "**product Id**" in the this page.
