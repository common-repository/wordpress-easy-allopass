...
if (isset($_GET['edit']) and $_GET['edit'] != "")
	...
	//
	$id_array = explode('/',$id_allopass);
	$id_site = $id_array[0];
	$id_produit = $id_array[1];
	//
...
?> 
  ...
  <tr>
	...
	<tbody>
      ...
      <tr>
        <td width="25%"><div align="left"><?php _e( 'Your site Id', 'wp-easy-allopass' ) ?>: </div></td>
        <td width="75%"><div align="left"><input type=text name=id_site value="<?php echo $id_site ?>" style='width:200px' <?php echo $disabled ?>></div></td>
      </tr>	
      <tr>
        <td width="25%"><div align="left"><?php _e( 'Your product Id', 'wp-easy-allopass' ) ?>: </div></td>
        <td width="75%"><div align="left"><input type=text name=id_produit value="<?php echo $id_produit ?>" style='width:200px' <?php echo $disabled ?>></div></td>
      </tr>

      <tr>
        <td>&nbsp;</td>
        <td><div align="left"><em> <?php _e( 'Id Product available on', 'wp-easy-allopass' ) ?> <a href="http://<?php echo $lang ?>.allopass.com/advert?from=sponsorship&target=1605852" target="_blank"><?php _e( 'your allopass account', 'wp-easy-allopass' ) ?></a>. &lt;&lt; <a href="<?php echo URL_HELP.$lang."/" ?>" target="_blank"><?php _e( 'Need Help?', 'wp-easy-allopass' ) ?></a></div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
    ...
    <td><div align="left"><img src="<?php echo URL_WEA ?>image/allo<?php echo $lang ?>.gif" width="534" height="400" /></div></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  </tr>
